 ...
 */
  ...
  var baseLayers = [
    {
      ...
      urlTemplate: 'http://t{s}.tianditu.gov.cn/DataServer?T=vec_c&x={x}&y={y}&l={z}',
    ...
    },
    {
      ...
      layerType: 'TileLayer',
      tileSystem: [1, -1, -180, 90],
      urlTemplate: 'http://t{s}.tianditu.gov.cn/DataServer?T=cva_c&x={x}&y={y}&l={z}',
      subdomains: ['1', '2', '3', '4', '5'],
      visible: true,
      crossOrigin: 'anonymous'
    },
    {
      ...
      layerType: 'TileLayer',
      tileSystem: [1, -1, -180, 90],
      urlTemplate: 'http://t{s}.tianditu.gov.cn/DataServer?T=img_c&x={x}&y={y}&l={z}',
      subdomains: ['1', '2', '3', '4', '5'],
      visible: false,
      crossOrigin: 'anonymous'
    },
    {
      ...
      layerType: 'TileLayer',
      tileSystem: [1, -1, -180, 90],
      urlTemplate: 'http://t{s}.tianditu.gov.cn/DataServer?T=cia_c&x={x}&y={y}&l={z}',
      subdomains: ['1', '2', '3', '4', '5'],
      visible: false,
      crossOrigin: 'anonymous'
    },
    {
      ...
      layerType: 'TileLayer',
      tileSystem: [1, -1, -180, 90],
      urlTemplate: 'http://t{s}.tianditu.gov.cn/DataServer?T=ter_c&x={x}&y={y}&l={z}',
      subdomains: ['1', '2', '3', '4', '5'],
      visible: false,
      crossOrigin: 'anonymous'
    },
    {
      ...
      layerType: 'TileLayer',
      tileSystem: [1, -1, -180, 90],
      urlTemplate: 'http://t{s}.tianditu.gov.cn/DataServer?T=cta_c&x={x}&y={y}&l={z}',
      subdomains: ['1', '2', '3', '4', '5'],
      visible: false,
      crossOrigin: 'anonymous'
    }
  ...
  var boundary = [
    './static/assets/data/S_FeaturesToJSON2.json',
    './static/assets/data/X_FeaturesToJSON2.json'
  ]
  var lakeshp = [
    './static/assets/data/lake.json'
  ]
  ...
  var misConfig = {
    ...
    oneKeySchedulingByResponseLevel: '/wuhan-site/event/headquarter/gis/manager/essential?eventId=',
    // 捷思锐账号
    getJsrAccountInfo: '/wuhan-site/basedata/getJsrAccountInfo',
    // 根据预案获取指挥部信息
    planInfoByEventType: '/wuhan-site/eppManage/eppManage/findByEventType?eventType=',
    headquartersInfoByPlan: '/wuhan-site/event/headquarter/gis/manage/getGroups?planId=',
    // 内嵌手机详情展示页面
    // instructInfoGis: 'http://yjpt.wuhan.gov.cn:9000/geminihtml/index.html#/deal/instructInfoViewPc/2/'
    instructInfoGis: 'https://whyj.gsafetyweixinsupport.cn/geminihtml/index.html#/deal/instructInfoViewPc/2/'
  }
  var statisticsEvent = [
