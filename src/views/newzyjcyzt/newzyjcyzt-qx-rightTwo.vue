 ...
 * @LastEditTime: 2019-08-09 15:15:27
 -->
      ...
      <div class="jcz">
        ...
        <ul class="jczbox">
          <li v-for="(item,index) in list" :key="index">
            <p>{{className== '水库'?item.STNM:item.STNM}}</p>
            <p>{{className== '水库'?item.ZC:item.Z}}</p>
            <p>{{className== '水库'?item.BZ:item.Z}}</p>
          </li>
        </ul>
      </div>
    </div>
...
.zyjcyzt_rightTwo .el-icon-arrow-right {
  background: white url("../../../static/assets/img/zyjcyzt/jiantou002.jpg")
...
.xuanzhong {
  ...
  position: relative;
  .img {
    background: url("../../../static/assets/img/zyjcyzt/shuiku-1.png") center
...
.xuanzhong2 {
  ...
  position: relative;
  .img {
    background: url("../../../static/assets/img/zyjcyzt/hedao-1.png") center
      center no-repeat !important;
    background-size: 100% 100%;
  }
}
.shuihe > p:nth-child(1) > .img {
  ...
  top: 4 * @px;
  left: 120 * @px;
  background: url("../../../static/assets/img/zyjcyzt/shuiku-2.png") center
    center no-repeat;
  background-size: 100% 100%;
}
...
.shuihe > p:nth-child(2) > .img {
  ...
  top: 4 * @px;
  left: 120 * @px;
  background: url("../../../static/assets/img/zyjcyzt/hedao-2.png") center
    center no-repeat;
  background-size: 100% 100%;
}
.jcz {
  margin: 20 * @px 22 * @px 18 * @px;
}
.jcztitle {
  display: flex;
  display: box;
